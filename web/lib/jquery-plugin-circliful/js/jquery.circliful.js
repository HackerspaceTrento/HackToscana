...
(function ($) {
    ...
    $.fn.circliful = function (options, callback) {
        ...
        return this.each(function () {
            ...
            var customSettings = ["text", "info", "total", "fgcolor", "bgcolor", "fill", "width", "dimension", "fontsize", "animationstep", "endPercent", "icon", "iconcolor", "iconsize", "border", "startdegree", "bordersize", "delay"];
            ...
            function checkDataAttributes(obj) {
                $.each(customSettings, function (index, attribute) {
                    if (obj.data(attribute) != undefined) {
                        ...
                        var val = $(settings).attr(attribute);
                        obj.data(attribute, val);
                        customSettingsObj[attribute] = val;
                    }
